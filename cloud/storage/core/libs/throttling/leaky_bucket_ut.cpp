...
// GET_SHARE_AND_CHECK
#define GET_AND_CHECK(currentShare)                                            \
        UNIT_ASSERT_VALUES_EQUAL(                                              \
            currentShare,                                                      \
            lb.CalculateCurrentSpentBudget()                                   \
        );                                                                     \
// GET_SHARE_AND_CHECK
    ...
    Y_UNIT_TEST(ShouldCorrectlyCalculateBoostedTimeBucketWithCustomInitialBudget)
    {
        TBoostedTimeBucket lb(
            TDuration::MilliSeconds(100),
            11,
    ...
    Y_UNIT_TEST(ShouldCorrectlyCalculateBoostedTimeBucketZeroBoostRefillRateWithCustomInitialBudget)
    {
        TBoostedTimeBucket lb(
            TDuration::MilliSeconds(100),
            11,
